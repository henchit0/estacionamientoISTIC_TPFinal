  ...
  <header>
  	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  	  ...
  	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a class="nav-link detalle" href="index.php">Home <span class="sr-only">(current)</span></a>          
        </li>
        <?php 
          if (isset($_SESSION['idDeUsuario']) && $_SESSION['perfil'] == 'Admin')
          {
        ?>
          <li class="nav-item detalle">
          ...
          ?>           
            ...
            <li class="nav-item">
              <a class="nav-link" href="acciones/hacerLogout.php"><img class="pr-2" src="img/import.png">Logout</a>
            </li> 
          <?php  
          }
           else
