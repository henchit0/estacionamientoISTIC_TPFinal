        ...
        <div class="col-sm-4 pl-5 pr-5">
          <form action="../acciones/hacerVehiculo.php">
            ...
            <div class="form-group">
              <label>Patente</label>
              <input type="text" name="inputPatente" class="form-control"  aria-describedby="emailHelp" placeholder="Ingresar patente" onchange="javascript:this.value=this.value.toUpperCase();">
            </div>                        
