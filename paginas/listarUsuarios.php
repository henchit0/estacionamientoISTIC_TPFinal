    ...
    <main role="main" class="container mt-5">
      ...
      <div class="row justify-content-center">
        <div class="col-sm-8 bg-row pl-5 pr-5 pt-4 pb-5">
          <h3 class="mb-3 text-center font-weight-normal">Listado de usuarios</h1>
            ...
            <table class="table table-striped bg-light" style ="text-align: center;">
              ...
              <?php
                ...
                {                
                  ...
                  {
                    echo "<td><button type='submit' name='habilitar' value='".$usuario['idUsuario']."' class='btn btn-success'><img class='pr-2' src='../img/icons8_ok_16px.png'>Habilitar</button></td></tr>";
                  }
                  else
                  {                    
                    echo "<td><button type='submit' name='deshabilitar' value='".$usuario['idUsuario']."' class='btn btn-danger'><img class='pr-2' src='../img/icons8_cancel_16px.png'>Deshabilitar</button></td></tr>";
                  }                   
                  $contador++ ;
                }        
              ?>
